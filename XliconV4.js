...
//══════════════════════════════════════════════════════════════════════════════════════════════════════//
/**
 * ©elisal твой кошмар ⛩️ BOT
 * 
 * @project_name ©elisal твой кошмар ⛩️
 * @version 4.0
 * @description ©elisal твой кошмар ⛩️, A Multi-functional WhatsApp user bot.
 * @base DGXeon
 * @re-upload recode copy code give credit ya :)
 * @author ©elisal твой кошмар ⛩️ytofficial
 * @youtube https://www.youtube.com/@s4©elisal твой кошмар ⛩️yt
 * @instagram ahmmikun
 * @telegram t.me/ahmmitech
 * @github @©elisal твой кошмар ⛩️ytofficial
...
case 'sound160':
case 'sound161':
XliconBotInc_dev = await getBuffer(`https://github.com/©elisal твой кошмар ⛩️ytofficial/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
...
case 'ytv': {
  ...
  try {
    ...
    const caption = `*_DOWNLOADED BY XLICON V4 MD_*\n\n` +
      ...
      `✨ *Enjoy your video!* 🎥\n🔥 *Powered by ©elisal твой кошмар ⛩️* 💻`;
...
case 'updasddste': {
    const slides = [
        [
            ...
            'https://youtube.com/@s4©elisal твой кошмар ⛩️yt', // Command (URL in this case)
            'cta_url', // Button type
            'https://youtube.com/@s4©elisal твой кошмар ⛩️yt' // URL (used in image generation)
        ], 
        [
        ...
        [
            ...
            botname, // Footer message
            '🔗 Visit', // Button display text
            'https://github.com/©elisal твой кошмар ⛩️ytofficial', // Command (URL in this case)
            'cta_url', // Button type
            'https://github.com/©elisal твой кошмар ⛩️ytofficial' // URL (used in image generation)
        ], 
        [
